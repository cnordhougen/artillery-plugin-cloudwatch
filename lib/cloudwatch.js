...
var aws = require('aws-sdk'),
    ...
    impl = {
        ...
        buildCloudWatchErrorParams: function(namespace, timestamp, codes) {
            var cloudWatchParams = {
                    Namespace: namespace,
                    MetricData: []
                },
        ...
        CloudWatchPlugin: function(scriptConfig, eventEmitter) {
            ...
            eventEmitter.on('done', function (report) {
                ...
                if(result && result.codes) {
                    cloudWatch.putMetricData(buildCloudWatchErrorParams(self.config[constants.PLUGIN_PARAM_NAMESPACE], report.timestamp, report.codes), reportError);
                }
