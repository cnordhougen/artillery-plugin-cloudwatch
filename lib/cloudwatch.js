        ...
        CloudWatchPlugin: function(scriptConfig, eventEmitter) {
            ...
            eventEmitter.on('done', function (report) {
                ...
                if(report && report.codes) {
                    cloudWatch.putMetricData(buildCloudWatchErrorParams(self.config[constants.PLUGIN_PARAM_NAMESPACE], self.config[constants.PLUGIN_PARAM_DIMENSIONS], report.timestamp, report.codes), reportError);
                }
